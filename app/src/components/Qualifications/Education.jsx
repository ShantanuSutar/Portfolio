                ...
                <div className="flex justify-start w-full mx-auto items-center">
                  <div className="w-full sm:w-1/2 sm:pr-8">
                    <div className="p-4 bg-white rounded shadow-md hover:shadow-2xl transition-all ease-linear font-medium ">
                      <h3 className=" text-xl text-slate-900">Btech in CS</h3>
                      <span className="text-slate-500">PCCOE Pune</span>
              ...
              <div className="flex flex-col sm:flex-row items-center">
                <div className="flex justify-end w-full mx-auto items-center">
                  <div className="w-full sm:w-1/2 sm:pl-8">
                    <div className="p-4 bg-white rounded shadow-md hover:shadow-2xl transition-all ease-linear font-medium">
                      <h3 className=" text-xl  text-slate-900">High School</h3>
                      <span className="text-slate-500">97.77 (MHTCET)</span>
                      <div className=" flex items-center gap-2 mt-3 text-slate-500">
                        <AiTwotoneCalendar />
                        2019-2021
                      </div>
            ...
            <div className="mt-6 sm:mt-0 ">
              <div className="flex flex-col sm:flex-row items-center">
                <div className="flex justify-start w-full mx-auto items-center">
                  <div className="w-full sm:w-1/2 sm:pr-8">
                    <div className="p-4 bg-white rounded shadow-md hover:shadow-2xl transition-all ease-linear font-medium">
                      <h3 className=" text-xl  text-slate-900">School</h3>
                      <span className="text-slate-500">86% (Boards)</span>
                      <div className=" flex items-center gap-2 mt-3 text-slate-500">
                        <AiTwotoneCalendar />
                        2009-2019
                      </div>
